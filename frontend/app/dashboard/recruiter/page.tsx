...
export default function RecruiterDashboardPage() {
  ...
  return (
    <div className="space-y-10">
      <div>
        <h1 className="text-2xl font-semibold text-slate-900">Recruiter paneli</h1>
        <p className="mt-2 text-sm text-slate-600">
          Elanlarınız və müraciətlərin ümumi görüntüsü.
        </p>
      </div>
      ...
      {summary ? (
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="glass-panel rounded-2xl p-6">
            <p className="text-sm text-slate-500">Elanlarım</p>
            <p className="mt-2 text-3xl font-semibold text-slate-900">
              {summary.my_jobs_total}
            </p>
          </div>
          <div className="glass-panel rounded-2xl p-6">
            <p className="text-sm text-slate-500">Aktiv elan</p>
